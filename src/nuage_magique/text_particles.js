...
// - Wrap multi-lignes par nb de caractères (support '/n')
...
const DEFAULT_FONT_URLS = [
  new URL("./fonts/Noto Sans_Regular.json", import.meta.url).href,               // 1) Latin étendu (accents)
  new URL("./fonts/NotoSans-Regular.typeface.json", import.meta.url).href,         // 2) autre option
  new URL("./fonts/helvetiker_regular.typeface.json", import.meta.url).href        // 3) fallback ASCII
];
