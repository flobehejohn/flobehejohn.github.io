...
/**
 * Effet machine � �crire enrichi avec animation de surbrillance
 * @param {HTMLElement} element - �l�ment cible
  ...
  function write() {
    if (i < nodes.length) {
      ...
      if (node.nodeType === Node.TEXT_NODE) {
        ...
        strong.classList.add("highlight-pop");
      ...
      setTimeout(() => requestAnimationFrame(write), 8 * speedFactor); // d�lai ajust�
    } else {
      onComplete();
    }
  }
