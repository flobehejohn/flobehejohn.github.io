              ...
              return o.replace.call(n + "", t, function (t, n, r) {
                ...
                switch (n) {
                  ...
                  default:
                    ...
                    if (!n) return t;
                    while (n > e.length - 3)
                      (s = String.prototype.slice.call(n, -1) + s),
                        (n = Math.floor(n / 10));
                    return (n ? e[n] || "" : "$") + s;
                }
              });
  ...
  var SyntaxHighlighter = (function () {
    ...
    function m(e, t, n, r, i) {
      var s = (screen.width - n) / 2,
        o = (screen.height - r) / 2;
      (i += ", left=" + s + ", top=" + o + ", width=" + n + ", height=" + r),
        (i = i.replace(/^,/, ""));
    ...
    function k(t) {
      var n = /<br/s*//?>|&lt;br/s*//?&gt;/gi;
      return (
        e.config.bloggerMode == 1 && (t = t.replace(n, "/n")),
    ...
    function P(e) {
      ...
      var u = r.length;
      return (
        r.indexOf(n) == u - o && ((r = r.substring(0, u - o)), (i = !0)),
        i ? r : e
      );
    }
    function H(e) {
    ...
    return (
      ...
      (e.HtmlScript = function (t) {
        ...
        function l(e, t) {
          ...
          a.left != null &&
            e.left != null &&
            ((l = M(e.left, a.left)), f(l, e.index), (s = s.concat(l))),
            a.right != null &&
              e.right != null &&
              ((l = M(e.right, a.right)),
          ...
          for (var t = 0; t < e.length; t++) {
            ...
            for (var i = t + 1; i < e.length && e[t] !== null; i++) {
              ...
              s.index == n.index && s.length > n.length
                ? (e[t] = null)
                : s.index >= n.index && s.index < r && (e[i] = null);
            }
          }
          return e;
        },
        ...
        getHtml: function (t) {
          ...
          return (
            ...
            (n =
              ...
              "<tr>" +
              (gutter
                ? '<td class="gutter">' + this.getLineNumbersHtml(t) + "</td>"
                : "") +
              '<td class="code">' +
              '<div class="container">' +
              n +
